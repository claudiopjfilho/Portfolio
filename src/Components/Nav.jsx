  ...
  return (
    <div>
      <header className="`  py-2   ${visible ? 'top-0' : ''} `">
        <div className="fixed   z-50 -mt-2 h-16  flex items-center justify-between xl:max-w-full xl:mx-auto max-w-full px-[8%] flex-wrap w-full border bg-violet-900  border-gray-800">
          <div
            className={`${
              open ? "fixed  " : ""
            }flex justify-between w-80  z-40`}
          >
          ...
          <nav
            className={`${
              open ? " flex   " : "hidden"
            } bg-violet-900 p-3 rounded-lg  z-0 ml-64  lg:flex lg:items-center lg:w-auto `}
          >
